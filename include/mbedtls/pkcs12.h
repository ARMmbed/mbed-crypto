 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_pkcs12_pbe_sha1_rc4_128( mbedtls_asn1_buf *pbe_params, int mode,
 ...
 * \return           0 if successful, or a MBEDTLS_ERR_XXX code
 */
MBEDCRYPTO_EXPORT int mbedtls_pkcs12_pbe( mbedtls_asn1_buf *pbe_params, int mode,
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_pkcs12_derivation( unsigned char *data, size_t datalen,
                       const unsigned char *pwd, size_t pwdlen,
