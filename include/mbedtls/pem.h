 ...
 */
MBEDCRYPTO_EXPORT void mbedtls_pem_init( mbedtls_pem_context *ctx );
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_pem_read_buffer( mbedtls_pem_context *ctx, const char *header, const char *footer,
 ...
 */
MBEDCRYPTO_EXPORT void mbedtls_pem_free( mbedtls_pem_context *ctx );
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_pem_write_buffer( const char *header, const char *footer,
